...
//------------------ 样式定义 ---------------------------//  
//功能按钮同样样式  
var s_tiannet_turn_base = "height:16px;width:20px;font-size:9pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#2650A6;";  
//翻年、月等的按钮  
var s_tiannet_turn = "width:28px;" + s_tiannet_turn_base;  
//关闭、清空等按钮样式  
var s_tiannet_turn2 = "width:40px;" + s_tiannet_turn_base;  
//年选择下拉框  
var s_tiannet_select = "width:64px;display:none;";  
//月、时、分选择下拉框  
var s_tiannet_select2 = "width:76px;display:none;";  
//日期选择控件体的样式  
var s_tiannet_body = "width:280;background-color:#2650A6;display:none;z-index:9998;position:absolute;" +  
"border-left:1 solid #CCCCCC;border-top:1 solid #CCCCCC;border-right:1 solid #999999;border-bottom:1 solid #999999;";  
//显示日的td的样式  
var s_tiannet_day = "width:40px;height:20px;background-color:#D8F0FC;font-size:10pt;";  
//字体样式  
var s_tiannet_font = "color:#FFCC00;font-size:18pt;cursor:hand;";  
//链接的样式  
...
//输出星期  
document.write('<td width="40" align="center" Author="tiannet">' + weekName[i] + '</td>');  
}  
document.write(' </tr>');  
...
tiannetWriteHead();  
showTime();   
var father=document.getElementById("other");
father.appendChild(divTiannetDate);
tiannetShowControl();  
selectObject();  
}  
//隐藏日历控件(同时显示被强制隐藏的标签)  
...
var temp=document.getElementsByTagName(strTagName);
