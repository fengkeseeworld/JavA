...
<html>
  <head>
    ...
    <title>My JSP 'equipment_update.jsp' starting page</title>
  ...
  <body class="room_find_body">
    <h2>更新已有的设备</h2>
	<form action="<%=basePath%>room/updatequipment!equipmentUpdate"
		method="post">
		...
		<table style="margin-left: 30%;">
			<tr>
				<td>设备ID</td>
				<td><input type="text" name="equipmentId"
					placeholder="请输入正确的设备Id" /></td>
			</tr>
			<tr>
				<td>设备数量</td>
		...
		<div class="center">
			<input type="reset" value="取消" class="button" /> <input
				type="submit" value="更新" class="button" />
		</div>
	</form>
  </body>
</html>
